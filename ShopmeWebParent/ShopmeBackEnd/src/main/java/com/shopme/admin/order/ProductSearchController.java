...
public class ProductSearchController {
	...
	@Autowired ProductService services;
	...
	public String searchProductByPage(@PagingAndSortingParam(moduleURL ="/orders/search_product", listName="listProducts") 
		PagingAndSortingHelper helper,@PathVariable(name="pageNum") Integer pageNum) {
		services.searchProducts(pageNum, helper);
