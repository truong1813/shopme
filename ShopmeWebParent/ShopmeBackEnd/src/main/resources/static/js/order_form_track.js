...
function updateTrackCountNumbers(){
	$(".divCountTrack").each(function(index,elemnet){
...
function generateTrackCode(){
	...
	htmlCode=
			`<div class="row border rounded p-1"  id="${rowId}">
				<type="hidden" name="trackId" value="0" class="hiddenTrackId" />
				<div class="col-2">
					<div class="divCounTrack">${nextCount}</div>
